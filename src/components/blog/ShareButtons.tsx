...
function XIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.736-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </svg>
  );
}
...
const iconBtn = cn(
  "flex h-9 w-9 items-center justify-center rounded-full bg-onyx-100 text-onyx-600",
  "ring-1 ring-onyx-200 transition-all duration-200",
  "hover:bg-onyx-950 hover:text-white hover:ring-onyx-950",
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <button
        ...
        className={cn(
          iconBtn,
          copied && "bg-ember-500 text-white ring-ember-500 hover:bg-ember-600 hover:ring-ember-600"
        )}
      >
